...
<table border="1">
        ...
        <tbody>
            <tr>
                <td colspan="2">poloma 2020-2-22</td>
            </tr>
        </tbody>
</table>
```
...
| 属性 | 描述 |
| --- | --- |
| autoplay  | 如果出现该属性，则视频在就绪后马上播放（需要指定类型 type="video/mp4"） |
...
<video 
    ...
    width="800" 
    height="200">
        <source src="./poloma.mp4" type="video/mp4">
        <source src="./poloma.webm" type="video/webm">
</video>
```
